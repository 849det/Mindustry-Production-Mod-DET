# Mindustry Production Mod A4.4.4.D1.0
![GitHub Logo](/sprites/git/example.png)
This is a mod for Mindustry that gives you iron, steel, aluminum, oil processing, and alternative ways of generating materials like titanium, scrap, and thorium.
...
- Method 2: Open Mindustry, go to the mods, go to import from github, and enter "  ***/mindustry-production-mod-DET".


If you want to contact me, please do so over github (849det).
...
- Scrap Maker:
  - Input: 3 Copper + 2 Lead
  - Output: 1 Scrap

- Titanium Forge:
  - Input: 2 Lead + 3 Graphite
  - Output: 1 Titanium
...
- Advanced Light Oil Cracker
  - Input: 25 Light Oil + 1 Cracking Catalyst
  - Output: 20 Petroleum

- Advanced Heavy Oil Cracker
  - Input: 25 Heavy Oil + 1 Cracking Catalyst
  - Output: 20 Light Oil
...
- Plastic Conveyor:
  - Takes 2 Plastic + 1 Copper + 1 Lead
...
- Phase Drill
  ...
  - Size: 5x5
  - option Booster: 6 Water (1.75x speed)
  - Option Booster: 6 Cryofluid (3x speed)
